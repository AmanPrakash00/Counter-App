...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
      ...
      <div className="text-white">Project Date: 12/01/2024</div>
      <div className="text-white">Goal :- The main purpose of this project is to learn about event listeners in React and how to use state in different situations.</div>
    </div>
  );
}
